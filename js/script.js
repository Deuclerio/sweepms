...
(function () {
	...
	$( function () {
		...
		function initMaps () {
			...
			$.getScript( '//maps.googleapis.com/maps/api/js?' + (key ? 'key=' + key + '&' : '') + 'sensor=false&libraries=geometry,places&v=quarterly', function () {
		...
		function attachFormValidator(elements) {
			...
			regula.custom({
				name: 'PhoneNumber',
				defaultMessage: 'O formato de telefone é inválido.',
				validator: function() {
			...
			var regularConstraintsMessages = [
				{
					...
					newMessage: "Campo de preenchimento obrigatório."
				},
				{
		...
		if (plugins.rdMailForm.length) {
			var i, j, k,
				msg = {
					...
					'MF003': 'Por favor, defina o campo de e-mail em seu formulário!',
